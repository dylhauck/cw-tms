...
export async function createCustomer(formData: FormData) {
  ...
  const customer = await prisma.customer.create({
    data: {
      ...
      physicalAddress2: cleanValue(formData.get("physicalAddress2")),
      ...
      billingAddress2: cleanValue(formData.get("billingAddress2")),
...
export async function createCustomerLocation(
  ...
  const location = await prisma.customerLocation.create({
    data: {
      ...
      address,
      address2: cleanValue(formData.get("address2")),
      city,
      state,
      zip,
